...
//CREACION DEL NODO DE CONTROL PID
...
public:
  ...
  : Node("pid_control")
  {
    RCLCPP_INFO(this->get_logger(), "Inicio de control PID ubicando en posicion 0(Todos los vastagos hacia dentro)");
    ...
    subscription_2 = this->create_subscription<sensor_msgs::msg::JointState>("ref", 10, std::bind(&ControlAction::topic_callback2, this, _1)); 
...
private:
  ...
  void topic_callback2(const sensor_msgs::msg::JointState   & msg) const//const //const  // CHANGE
  {
   //OBTENCION DE POSICIONES ARTICULARES DE REFERENCIA
      qd[0]=msg.position[0];
      qd[1]=msg.position[1];
      qd[2]=msg.position[2];
      qd[3]=msg.position[3];
...
//ENVIO DE ACCIONES DE CONTROL
   ...
   rclcpp::Subscription<sensor_msgs::msg::JointState>::SharedPtr subscription_2;  
